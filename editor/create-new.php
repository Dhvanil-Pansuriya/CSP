...
if (isset($_POST["save-snippet-btn"])) {
    ...
    $sql = "INSERT INTO `code_snippets`(`snippet_id`, `title`, `html_code`, `css_code`,`js_code`, `created_on`, `author`) VALUES ('{$snippet_id}','{$title}','{$html_code}','{$css_code}', '{$js_code}',NOW(),'{$username}')";
